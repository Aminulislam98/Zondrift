  ...
  return (
    <div className="group bg-white rounded-xl border border-black/[0.06] overflow-hidden shadow p-2">
      <div className="flex flex-col sm:flex-row">
        {/* ── Image ── */}
        <div className="relative w-full h-[200px] sm:w-[240px] sm:h-auto sm:min-h-[180px] shrink-0 overflow-hidden rounded-md bg-black/[0.04]">
          {dest?.image ? (
            <Image
              src={dest.image}
            ...
            <div className="w-full h-full flex flex-col items-center justify-center gap-2">
              ...
              <span className="text-[11px] text-[#bbb] tracking-[-0.01em]">
                No image
              </span>
            </div>
          )}
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-[11px] text-[#bbb] tracking-[-0.01em] mt-0.5">
                from ${((dest?.price ?? 0) * 2).toLocaleString()} for 2
              </p>
            </div>
            <Link
